...
var reducer = combineReducers({
   isMenu , isMenuElement,isLoaddingDashboard ,isLoaddingTable, projectID ,setUserJWT ,idTopicProject ,VLNArray,V1NArray,V2NArray,V3NArray,CURRENT,FArray,EArray,SUMMARY,PhaseOne,PhaseTwo,PhaseThree,RLA,RLB,RL
});
